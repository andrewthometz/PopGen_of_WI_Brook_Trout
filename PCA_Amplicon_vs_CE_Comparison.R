...
########################################################################################################################
#### Run principle component analyses using amplicon data and capillary electrophoresis data to compare the results ####
########################################################################################################################
...
# Fill the 2111 project pop slot and subset to just domestic strain fish
...
# Fill 2111 project pop slot and subset to just domestic strain fish
...
# Run PCA with just capillary electrophoresis data
